...
@section('content')
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            <div>
                <h2 class="text-2xl font-semibold leading-tight">Create New Post</h2>
            </div>
            <div class="mt-5 md:mt-0 md:col-span-2">
                ...
                <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data"> {{-- Add enctype for file uploads --}}
                    @csrf
                        ...
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            ...
                            <div>
                                ...
                                <textarea name="content" id="content" rows="15"
                                          class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md tinymce-editor">{{ old('content') }}</textarea>
                            </div>
